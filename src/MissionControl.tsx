...
function MissionControl() {
  ...
  return <div className="mc-shell">
    <header className="mc-topbar">
      ...
      <a className="storyline-button" href="https://github.com/ravi0130/CopilotWith-RVAS/raw/refs/heads/main/docs/STORYLINE.docx"><FileText /> STORYLINE</a>
      ...
      {menuOpen && <nav className="mobile-nav"><button onClick={() => go('possibility')}>GHCP · Art of Possibility</button><button onClick={openDemos}>DEMOS · Demo Studio</button><a href="https://github.com/ravi0130/CopilotWith-RVAS/raw/refs/heads/main/docs/STORYLINE.docx">STORYLINE · Word guide</a>{programmeScenes.map((item, index) => <button key={item.id} onClick={() => go(item.id)}>{String(index + 1).padStart(2, '0')} · {item.label}</button>)}</nav>}
    </header>
